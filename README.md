This is window classic desktop application that finds the amount of monthly pay if paid a penny or a nickel for the first workday and the pay is doubled each subsequent workday.
